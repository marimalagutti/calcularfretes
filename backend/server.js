//IMPORTAR O MODO EXPRESS- framework de aplicação web para Node.js
const express = require('express')
//MÓDULO QUE PERMITE QUE O SERVIDOR ACEITE REQUISIÇÕES DIFERENTES (DOMÍNIO)
const cors = require('cors');

//Intanciando express para app
const app = express();
...
app.post('/calcularfrete',(req,res)=>{
    ...
    //verifica se a distancia ou tipotransporte não foram oferecidos
...
//INICIA O SERVIDOR PARA QUE ELE COMECE AS REQUISIÇÕES NA PORTA
app.listen(port,()=>{
